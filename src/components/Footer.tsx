    ...
    <footer className="bg-[#0A192F]">
      ...
      <div className="border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <Link
            to="/contact"
            className="shrink-0 inline-flex items-center gap-2 px-6 py-3 rounded-full bg-emerald-500 hover:bg-emerald-600
                       text-white font-semibold text-sm transition-all duration-200 shadow-lg shadow-emerald-900/30 hover:-translate-y-0.5"
          >
        ...
        <div className="space-y-7">
          <div>
            ...
            <div className="space-y-2 text-sm text-slate-400">
              ...
              <div className="flex gap-2">
                <Phone size={13} className="text-emerald-500 mt-0.5 shrink-0" />
                <span>+61 3 9342 2458</span>
              </div>
              <div className="flex gap-2">
                <PrinterIcon size={13} className="text-emerald-500 mt-0.5 shrink-0" />
      ...
      {/* Bottom bar */}
      <div className="border-t border-white/[0.07] px-6 py-5 max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-3">
