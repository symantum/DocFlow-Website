  ...
  return (
    <div className="pt-28 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* AP Portal */}
        <section className="mb-16" id="ap-portal">
          <div className="glass-card border border-blue-400/20 overflow-hidden">
            <div className="bg-blue-400/[0.04] border-b border-blue-400/20 px-8 py-8">
            ...
            {/* Pipeline strip */}
            <div className="px-8 py-5 bg-white/[0.02] border-b border-white/[0.06]">
              <div className="flex flex-wrap items-center gap-2">
                {['Email Intake', 'OCR Extraction', 'AI Validation', 'HITL Review', 'AP Push'].map((step, i) => (
                  <div key={step} className="flex items-center gap-2">
                    <span className="px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-300 text-xs font-medium">{step}</span>
            ...
            <div className="mx-8 mb-8 p-4 rounded-xl bg-white/[0.03] border border-white/[0.06]">
        ...
        <section id="csa-portal">
          <div className="glass-card border border-cyan-400/20 overflow-hidden">
            <div className="bg-cyan-400/[0.04] border-b border-cyan-400/20 px-8 py-8">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                <div>
                  <div className="flex items-center gap-3 mb-3">
