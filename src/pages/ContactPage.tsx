...
export default function ContactPage() {
  ...
  const inputClass = "w-full bg-white/[0.04] border border-white/[0.1] rounded-xl px-4 py-3 text-sm text-slate-100 placeholder-slate-600 focus:outline-none focus:border-blue-500/60 focus:bg-white/[0.06] transition-all"
    ...
    <div className="pt-28 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-14">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-white mb-4">Talk to us</h1>
          ...
          <div className="lg:col-span-2">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="glass-card p-8 space-y-5">
                ...
                <button type="submit"
                  className="w-full py-3.5 rounded-full bg-blue-600 hover:bg-blue-500 text-white font-semibold transition-all shadow-lg shadow-blue-900/30 flex items-center justify-center gap-2"
                >
          ...
          <div className="space-y-5">
            <div className="feature-card p-6">
              ...
              <div className="space-y-2 text-sm text-slate-400">
                <div className="flex gap-2"><MapPin size={14} className="text-blue-400 mt-0.5 shrink-0" /><span>247 Bouverie Street, Carlton VIC 3053</span></div>
                <div className="flex gap-2"><Phone size={14} className="text-blue-400 mt-0.5 shrink-0" /><span>+61 3 9342 2458</span></div>
              </div>
            </div>
            ...
            <div className="feature-card p-6">
              ...
              <div className="space-y-2 text-sm text-slate-400">
                <div className="flex gap-2"><MapPin size={14} className="text-blue-400 mt-0.5 shrink-0" /><span>B306 Han Yun, Xi'an Software Development Zone, Shaanxi</span></div>
                <div className="flex gap-2"><Phone size={14} className="text-blue-400 mt-0.5 shrink-0" /><span>+86 29 8760 7723</span></div>
              </div>
            </div>
